...
<!--
  `data-highlighted:` alongside `focus:`, as on the select item: bits-ui never
  moves DOM focus into the menu, it tracks the active entry with
  `aria-activedescendant`, so `focus:` alone highlights nothing while the user
  arrows down the list.
-->
