...
import type { PermissionTarget } from '@platform/authz/domain/entities/effective-permissions.entity.ts';
import { useAuthorization } from '@platform/authz/presentation/hooks/use-authorization.ts';
import { PermissionDenied } from '@platform/authz/presentation/ui/PermissionDenied.tsx';
