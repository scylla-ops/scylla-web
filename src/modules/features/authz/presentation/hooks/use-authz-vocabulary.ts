 ...
 * permission is usable at that scope or any broader (ancestor) one. Scope enum
 * values are ordered broad→narrow (SYSTEM=1 < ORGANIZATION=2 < PROJECT=3), so
 * "broader or equal" is simply `scope <= minScope`.
 */
