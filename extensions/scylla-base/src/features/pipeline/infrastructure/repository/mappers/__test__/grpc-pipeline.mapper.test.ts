...
import { Shell } from '@base/generated/scylla/exec/v1/step.ts';
import type { Pipeline, PipelineNode, PipelineSummary, EnvVar } from '@base/generated/scylla/pipeline/v1/pipeline.ts';
import type { PipelineStep, EnvEntry } from '@base/features/pipeline/domain/structs/pipeline.struct.ts';
