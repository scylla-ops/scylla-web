import { createQueries, createQuery } from '@scylla/core-sdk';
import { jobsByPipelinesQueries, type JobEntity } from '@base/features/jobs';
import { createPagination } from '@scylla/ui/state';
