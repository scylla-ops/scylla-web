import type { PermissionRepository, RevokeAllAccessInput } from '@base/features/roles/domain/repository/permission.repository.ts';
import type { CreateGrantInput } from '@base/features/roles/domain/repository/permission.repository.ts';
import { ScyllaResult } from '@shared/utils/scylla-result.ts';
import type { PrincipalEntity, PermissionScope, } from '@platform/authz';
import type { GrpcPermissionRemoteDataSource } from '@base/features/roles/infrastructure/data/grpc-permission-remote.data-source.ts';
import type {
  RoleCreationData,
  RoleEntity,
} from '@base/features/roles/domain/entities/role.entity.ts';
import type { GrantEntity } from '@base/features/roles/domain/entities/grant.entity.ts';
...
import { GrpcRoleMapper } from '@base/features/roles/infrastructure/repository/mappers/grpc-role.mapper.ts';
import { GrpcGrantMapper } from '@base/features/roles/infrastructure/repository/mappers/grpc-grant.mapper.ts';
import { GrpcGrantableRoleMapper } from '@base/features/roles/infrastructure/repository/mappers/grpc-grantable-role.mapper.ts';
import { GrpcEffectivePermissionsMapper } from '@base/features/roles/infrastructure/repository/mappers/grpc-effective-permissions.mapper.ts';
import { GrpcPermissionVocabularyMapper } from '@base/features/roles/infrastructure/repository/mappers/grpc-permission-vocabulary.mapper.ts';
