import type { AppsRepository } from '@base/features/apps/domain/repository/apps.repository.ts';
import type { AppsRemoteDataSource } from '@base/features/apps/infrastructure/data/apps-remote.data-source.ts';
