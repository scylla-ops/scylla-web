import type { AgentsRepository } from '@base/features/agents/domain/repository/agents.repository.ts';
import type { AgentsRemoteDataSource } from '@base/features/agents/infrastructure/data/agents-remote.data-source.ts';
