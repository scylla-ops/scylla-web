...
} from '@base/generated/scylla/agent/v1/agent_admin.ts';
import type {
  AgentEntity,
  AgentHost,
} from '@base/features/agents/domain/entities/agent.entity.ts';
import type { AgentStats } from '@base/features/agents/domain/structs/agent.struct.ts';
