...
import type { TriggersRepository } from '@base/features/triggers/domain/repository/triggers.repository.ts';
...
import { GrpcTriggerMapper } from '@base/features/triggers/infrastructure/repository/mappers/grpc-trigger.mapper.ts';
