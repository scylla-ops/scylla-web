...
} from '@base/features/jobs/infrastructure/repository/data-sources/jobs-remote.data-source.ts';
import type {
  Job,
...
import { ScyllaError, ScyllaResult, ScyllaResult as Result } from '@shared/utils/scylla-result.ts';
import { JobServiceClient } from '@base/generated/scylla/job/v1/job.client.ts';
