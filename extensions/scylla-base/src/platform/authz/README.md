...
of [platform/routing](../../../../../packages/core/README.md) applies it — while the sidebar reads the *same*
...
- [platform/routing](../../../../../packages/core/README.md) — the route guard, which applies route permissions.
